...
| 🎙️ | [Voibe](https://www.getvoibe.com) | Voibe is a really fast dictation app for Mac built for AI power users. Works offline and fully private. Your data never leaves your Mac | **50% OFF** lifetime plan for BFCM |
...
| 🔗 | [LinkYourFile](https://linkyourfile.com) | Link your local files or folders in any web application. | **50% OFF** with code *BLACKWEEKS_2025* |
...
| 👍 | [Mentorbook](https://mentorbook.ai) | Your AI Mentor, Your Learning Assistant, Create any course, Learning anything. | **30% OFF** any plan with code **BF2025** (Nov 21 - Nov 30). |
...
| 🌍 | [OpenL Doc Translator](https://doc.openl.io/) | Online Document Translator, Accurate AI Translation with Original Formatting | **50% OFF**. Valid until Dec 1st. |
...
| 📝 | [BugSmash](https://bugsmash.io/) | Instant Visual Feedback & Collaboration for Product, Design, Marketing Teams & Agencies. Review live websites, designs, videos all in one place. Collect contextual annotated feedback from clients without asking them to login. | 🚀 Limited Time Black Friday Sale. Use Coupon Code “SPLBF100” at Checkout. $100 OFF with code “SPLBF100”. Lifetime at just $149! |
...
| 🔥 | [RightBlogger](https://rightblogger.com?utm_source=tonybf) | RightBlogger is the best AI article writer for bloggers, helping you automate your entire content workflow with powerful autoblogging features so you can drive more SEO and ChatGPT traffic effortlessly. | 50% OFF annual plans (automatically applied) |
...
| 📸 | [Rendley](https://rendley.com?utm_source=trungdq88) | Rendley is an online video editor that brings together all the editing tools you need to create great video content. | 35% OFF annual plan with code **RENDLEY35** |
| 🔔 | [Alertly](https://usealertly.com) | Get daily alerts when people mention your brand, competitors or niche – and jump in when it counts. | 20% OFF for one year with code **BLACK25** |
...
| 🛡️ | [Beagle Security](https://beaglesecurity.com/black-friday-sale) | AI-powered automated pentesting for web apps, APIs & GraphQL. Uses agentic AI to simulate real-world attacks and provide actionable vulnerability insights. | **35% OFF annual** — `BFCMY25` & **20% OFF monthly** — `BFCMM25` (valid 6 months on Essential & Advanced plans, **Nov 25–Dec 4, 2025**) |
| 🛠️ | [txtcv](https://txtcv.com) | Plaintext CV builder for developers using JSON resume with CLI support. | **50% OFF first year** with code **BFCM2025** |
...
| 🔋 | [EV Charge Stations Map](https://apple.co/3NWejUz) | Long distance EV route planner and charge stations. | 50% OFF lifetime plan with code **BLCKFRDY25** or using https://apps.apple.com/redeem?ctx=offercodes&id=6466442459&code=BLCKFRDY25 , Nov 13 - Dec 31 |
| ✈️ | [Travel Route Map](https://apple.co/3NZrXqi) | Animate your travel destinations on map. | 50% OFF lifetime plan with code **BLCKFRDY25** or using https://apps.apple.com/redeem?ctx=offercodes&id=6504141706&code=BLCKFRDY25 , Nov 13 - Dec 31 |
